...
const ColorGenrator = () => {
    ...
    const isLightColor = ( color ) => {
        try {
            const rgb = new Values( color ).rgb
    ...
    const lightColor = isLightColor( btnColor )
        ...
        <>
            <form className='w-[90%] lg:w-1/2 p-5 mx-auto shadow-2xl my-10 shadow-gray-600 rounded-md'>
                ...
                <input
                    ...
                    placeholder='e.g. red'
                    type="text"
                    className='w-full border border-gray-300 p-3 rounded-md my-3'
                />
                ...
                <button
                    ...
                    style={{
                        ...
                        border: lightColor ? '2px solid black' : 'none'
                    }}
                    className='w-full active:scale-95 p-2 rounded-md transition-all'
                >
                    Generate
                </button>
            </form>
